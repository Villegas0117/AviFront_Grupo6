  ...
  //hacer perición con el http client
    ...
    getTotalRecomendacionesPorIntervalo(fechaInicio: string, fechaFin: string): Observable<{ fechaInicio: string; fechaFin: string; totalRecomendaciones: number }> {
      return this.http.get<{ fechaInicio: string; fechaFin: string; totalRecomendaciones: number }>(
        `${this.url}/TotalRecomendacionesPorIntervalo`,
    ...
    getTopTendenciasConMasRecomendaciones(topN: number): Observable<ReTendenciasConMasRecomendacionesDTO[]> {
      return this.http.get<ReTendenciasConMasRecomendacionesDTO[]>(`${this.url}/TopTendenciasConMasRecomendaciones?topN=${topN}`);
    }
  }
